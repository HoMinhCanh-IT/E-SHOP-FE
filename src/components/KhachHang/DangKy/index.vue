<template>
    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2">
        <div class="col mx-auto" style="margin-top: 50px;">
            <div class="my-4 text-center">
                <!-- <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGKcszcomOFsZpGcqA2z9wzGCvlr7N3vyJ5A&s"
                    alt=""> -->
            </div>
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" v-model="khach_hang_create.dia_chi" class="form-control"
