               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="mb-2">
                        ...
                        <input v-on:blur="checkSlug()" v-model="create_san_pham.ten_san_pham" v-on:keyup="taoSlugSP()"
                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="mb-2">
                        ...
                        <textarea v-model="create_san_pham.mo_ta_chi_tiet" class="form-control mt-2" cols="30"
                           rows="5"></textarea>
                     </div>
                     <div class="mb-2">
                        <label>Tag</label>
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-6">
                     <div class="mb-2">
                        <label>Tên Sản Phẩm</label>
                        <input v-model="edit_san_pham.ten_san_pham" v-on:keyup="taoSlugSP()" type="text"
                           class="form-control mt-2">
                     </div>
                     <div class="mb-2">
                        <label>Slug Sản phẩm</label>
            ...
            <div class="card-header ">
               ...
               <div class="input-group mt-3 w-100">
                  <input v-on:keyup.enter="timKiem()" v-model="tim_kiem.noi_dung_tim" type="text"
                     class="form-control search-control border border-2 border-secondary" placeholder="Search...">
                     ...
                     <template v-for="(value, index) in list_san_pham" :key="index">
                        <tr>
                           ...
                           <td class="align-middle text-center">
                              <i v-on:click="mo_ta_chi_tiet_sp = value.mo_ta_chi_tiet"
                           ...
                           <td class="align-middle text-wrap">
                              <button v-on:click="chuyenBan(value)" v-if="value.tinh_trang == 1"
                                 class="btn btn-success text-nowrap mb-2">Đang Bán</button>
                              <button v-on:click="chuyenBan(value)" v-else class="btn btn-danger text-nowrap mb-2">Dừng
                                 Bán</button>

                              <button v-on:click="chuyenNoiBat(value)" v-if="value.is_noi_bat == 1"
                                 class="btn btn-primary text-nowrap mb-2">SP Nổi Bật</button>
                              <button v-on:click="chuyenNoiBat(value)" v-else
                                 class="btn btn-danger text-nowrap mb-2">Bình Thường</button>

                              <button v-on:click="chuyenFlashSale(value)" v-if="value.is_flash_sale == 1"
                                 class="btn btn-info text-nowrap mb-2">SP Flash</button>
                              <button v-on:click="chuyenFlashSale(value)" v-else
                                 class="btn btn-warning text-nowrap mb-2">Bình Thường</button>
                           </td>
