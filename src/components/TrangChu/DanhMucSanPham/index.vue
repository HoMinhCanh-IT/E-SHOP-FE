                                        ...
                                        <div class="btn-group" role="group"
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-xxl-end"
                                                    ...
                                                    <li><a v-on:click="sort = 1" class="dropdown-item" href="#">A -
                                                            Z</a>
                                                    </li>
                                                    <li><a v-on:click="sort = 2" class="dropdown-item" href="#">Z -
                                                            A</a>
                                                    </li>
                                                </ul>
                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6"><input v-model="end"
                                                                                class="form-control"
...
export default {
    ...
    data() {
        return {
            ...
            search_tag: '',
            begin: 0,
            end: 1000000000000, // max số tiền hiện nãy để có 10k dưới 10k éo có
        }
    },
